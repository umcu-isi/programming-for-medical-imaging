...
Detailed installation instructions can be found in the [Anaconda documentation][anaconda-install], or by following the instructions below.
...
To download the software from the webpage please click on "skip Registration" and then choose one of the Distribution installers.
